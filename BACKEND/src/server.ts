...
import { createUserProfileRouter } from './routes/user-profile.routes';  // Importing the user profile router
...
app.use('/api/v1/user/profile', createUserProfileRouter(db));  // Registering the user profile route
